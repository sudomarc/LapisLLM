...
class TrainingLogger:
    ...
    def start_run(self):
        ...
        print(
            f"Model: {self.config['model']['hidden_size']}-hidden, "
            f"{self.config['model']['num_layers']} layers"
        )
        mc = ModelConfig(self.config)
    ...
    def log_step(self, step, loss, learning_rate):
        ...
        print(
            f"Step {step}: Loss {loss:.4f} | Perplexity {ppl:.2f} | "
